...
''';
    ...
    final worldCupChannels = provider.filteredChannels
        .where((c) => c.category == 'World Cup')
        .toList();

    expect(worldCupChannels.length, 3);
    
    expect(worldCupChannels[0].name, 'BEIN MAX 1 **');
    expect(worldCupChannels[0].url, 'https://live.aab1.top:443/odai/123321/9087.ts');
    
    expect(worldCupChannels[1].name, 'BEIN SPORTS 1');
    expect(worldCupChannels[1].url, 'https://live.aab1.top:443/odai/123321/3.ts');
    
    expect(worldCupChannels[2].name, 'BEIN SPORTS 2');
    expect(worldCupChannels[2].url, 'https://live.aab1.top:443/odai/123321/6820.ts');
  });
}
